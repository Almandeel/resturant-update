                    ...
                    @permission('menus-read')
                          <div class="col-lg-6 col-xs-12">
                            ...
                            <div class="small-box bg-orange text-right">
                              ...
                              <a href="{{ route('restaurant.dashboard') }}" class="small-box-footer"> <i class="fa fa-arrow-circle-right"></i>  عرض  </a>
                            </div>
                          </div>
                    @endpermission
                    @permission('menus-read')
				...
				<div class="row">
                    <div class="col-lg-6 col-xs-12">
                      ...
                      <div class="small-box bg-aqua text-right">
                        ...
                        <a href="{{ route('management.index') }}" class="small-box-footer"> <i class="fa fa-arrow-circle-right"></i>  عرض  </a>
                      </div>
                    </div>
                    <div class="col-lg-6 col-xs-12">
                        <!-- small box -->
                        <div class="small-box bg-aqua text-right">
                          ...
                          <a href="{{ route('subscription.dashboard') }}" class="small-box-footer"> <i class="fa fa-arrow-circle-right"></i>  عرض  </a>
                        </div>
                      </div>
                </div>
            </section>
